...
void GLogic::Validmove(int X, int Y)
{
	...
	if (boardArray[X][Y] = NULL || pieces.bR || pieces.bN || pieces.bB || pieces.bQ || pieces.bB2 || pieces.bN2 || pieces.bR2 || pieces.bP1 || pieces.bP2 || pieces.bP3 || pieces.bP4 || pieces.bP5 || pieces.bP6 || pieces.bP7 || pieces.bP8);
		validMove = true;
...
void GLogic::ValidmovePawn(int X, int Y)
{
	pieces pieces;
